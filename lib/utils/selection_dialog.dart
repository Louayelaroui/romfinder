  ...
  Widget build(BuildContext context) => CustomTheme(
    child: SimpleDialog(
      title: Column(
        ...
        children: <Widget>[
          text("Select Country Code", textColor: Colors.blue ,  fontSize: 16.0, fontFamily: 'Semibold'),
          SizedBox(height: 8),
          TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(), fontSize: 18.0, textColor: Colors.blue)),
                text(e.dialCode, fontSize: 18.0, textColor: Colors.blue, fontFamily: 'Semibold'),
              ],
            ),
          ),
        ],
...
class CustomTheme extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Theme(
      data:  ThemeData.dark().copyWith(hintColor: Colors.blue, backgroundColor: context.scaffoldBackgroundColor,),
      child: child!,
    );
  }
}
