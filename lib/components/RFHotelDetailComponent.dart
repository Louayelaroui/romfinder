              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text('0 Applied', style: boldTextStyle(color:  rf_textColor)).flexible(),
                        4.width,
                        Container(height: 16, width: 1, color: context.iconColor),
                        4.width,
                        Text('19 Views', style: boldTextStyle(color:  rf_textColor)).flexible(),
                      ],
                    )
                  ],
                ).expand(),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'View on Google Maps',
                      style: primaryTextStyle(color: rf_textColor, decoration: TextDecoration.underline),
                    ).paddingOnly(left: 2),
                  ],
                ).expand()
              ],
