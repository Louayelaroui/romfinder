...
import '../components/RFAppliedHotelListComponent.dart';
      ...
      body: RFCommonAppComponent(
        ...
        subWidget: Column(
          ...
          children: [
              ...
              children: [
                OutlinedButton(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      rf_call.iconImage(iconColor:  rf_primaryColor),
                      8.width,
                      Text('Call Me', style: boldTextStyle(color:  rf_primaryColor)),
                    ],
                  ),
                ).expand(),
                16.width,
            ...
            Container(
              decoration: boxDecorationWithRoundedCorners(
                border: Border.all(color: rf_selectedCategoryBgColor),
                backgroundColor: context.cardColor,
              ),
